# Labour Disruption — Supply-Chain Disruption Response Standard

**Document ID:** SCR-STD-LAB-001  |  **Version:** 2.7  |  **Status:** Controlled  |  **Owner:** Supply Chain Resilience Office
...
This standard applies when the active disruption is a labour event. Where more than one type of disruption is active simultaneously, this type is addressed at priority 5 in the order geopolitical, natural disaster, cyber, economic, labour. The assessment runs in two passes, each working through provisions in order; the first provision whose conditions are fully satisfied takes effect and ends further checking within that pass.
...
### (LAB-NULL) Disruption outside network boundary
...
### (LAB-DT) Deep-tier structural fallthrough — no Tier-1 supplier scored
...
### (LAB-DT-NULL) Deep-tier with no structural concern
...
### (LAB-R3) Shared sub-tier convergence override
...
### (LAB-R1) High-risk Tier-1 directly in the disrupted region
...
### (LAB-SITE) Medium-to-high-risk supplier at struck site with high dependency ratio
...
### (LAB-R2) High-risk Tier-1 outside the disrupted region
...
### (LAB-MEDS) Medium-risk supplier flagged by the disruption-type priority signal
...
### (LAB-LOWS) Low-risk supplier flagged by the disruption-type priority signal
...
### (LAB-LOW) Low-risk routine supplier — catch-all
...
The standing posture for labour disruptions is **Continuity Protection**. Strikes can be prolonged / recurring: standing redundancy for strike-exposed suppliers (Tomlin 2006; viability, Ivanov & Dolgui 2020).
...
**EX-LAB-SITE** (illustrates provision LAB-SITE). Scenario: tier1_in_region: True; sub_dependency_ratio: high. The correct response is to **replace**, escalating to **Executive Leadership**.